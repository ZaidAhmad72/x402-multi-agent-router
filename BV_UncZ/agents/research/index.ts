/**
 * Research Agent — x402-gated service
 *
 * POST /work — task -> sourced bullet findings. $0.03 USDC.
...
import { handleResearchWork } from './handlers/work';
import { handleResearchRedeem } from './handlers/redeem';
import { runResearch } from './handlers/work';
